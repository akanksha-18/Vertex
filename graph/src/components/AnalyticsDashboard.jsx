...
//             <div 
//               className={`px-2 sm:px-4 py-3 cursor-pointer ${activeTab === 'Overview' ? 'border-b-2 border-white' : ''}`}
//               onClick={() => setActiveTab('Overview')}
//             >
//               Overview
//             </div>
//             <div 
//               className={`px-2 sm:px-4 py-3 cursor-pointer text-gray-600 ${activeTab === 'Demographics' ? 'border-b-2 border-white' : ''}`}
//               onClick={() => setActiveTab('Demographics')}
//             >
//               Demographics
//             </div>
//             <div className="flex-1 flex justify-end px-4 py-3">
//               <span>More</span>
//             </div>
//           </div>
          
//           {/* Dashboard Content */}
//           <div className="p-4 sm:p-6 bg-[#1d1d1d]">
//             <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Overview</h2>
            
//             <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
//               {/* Chart Section */}
//               <div className="lg:col-span-3 bg-black rounded-lg p-3 sm:p-4 order-1">
...
//                 {/* Stats - Responsive */}
//                 <div className="flex flex-wrap gap-6 sm:gap-12 mb-6">
//                   <div>
//                     <div className="text-xl sm:text-2xl font-bold">{currentChartData.primaryLine.stats.value}</div>
...
//                   </div>
//                   <div>
//                     <div className="text-xl sm:text-2xl font-bold">{currentChartData.secondaryLine.stats.value}</div>
//                     <div className="flex items-center">
...
//               {/* Insights Section */}
//               <div className="bg-black rounded-lg p-3 sm:p-4 order-2 lg:order-1">
...
//             <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
//               <div className="lg:col-span-3 bg-black rounded-lg p-3 sm:p-4">
//                 <div className="flex justify-between mb-4">
//                   <Dropdown
...
//                 <div className="h-40 sm:h-48 md:h-64 w-full relative">
...
//                   <div className="absolute top-1/4 left-1/4 w-3 h-3 sm:w-4 sm:h-4 bg-blue-600 rounded-full"></div>
//                   <div className="absolute top-1/3 left-1/5 w-3 h-3 sm:w-4 sm:h-4 bg-orange-500 rounded-full"></div>
//                   <div className="absolute top-1/4 left-1/6 w-3 h-3 sm:w-4 sm:h-4 bg-yellow-500 rounded-full"></div>
//                   <div className="absolute top-1/3 left-2/3 w-3 h-3 sm:w-4 sm:h-4 bg-green-500 rounded-full"></div>
              
//                   <div className="absolute bottom-2 left-2 flex flex-wrap gap-2 sm:gap-4">
...
//                       <IndiaFlag />
//                     </div>
//                     <span className="flex-1 text-sm">INDIA</span>
//                     <div className="w-10 sm:w-12 bg-gray-700 h-1.5 sm:h-2 rounded-full overflow-hidden">
...
//                       <USAFlag />
//                     </div>
//                     <span className="flex-1 text-sm">USA</span>
//                     <div className="w-10 sm:w-12 bg-gray-700 h-1.5 sm:h-2 rounded-full overflow-hidden">
...
//                       <CanadaFlag />
//                     </div>
//                     <span className="flex-1 text-sm">CANADA</span>
//                     <div className="w-10 sm:w-12 bg-gray-700 h-1.5 sm:h-2 rounded-full overflow-hidden">
...
//                       <UAEFlag />
//                     </div>
//                     <span className="flex-1 text-sm">UAE</span>
//                     <div className="w-10 sm:w-12 bg-gray-700 h-1.5 sm:h-2 rounded-full overflow-hidden">
...
//                 <div className="flex justify-end items-center mt-8 sm:mt-16 text-xs sm:text-sm">
